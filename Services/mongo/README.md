# Docker OS Images : MONGO on Fedora 26
...
| [![Build Status](https://travis-ci.org/startxfr/docker-images.svg?branch=fc26)](https://travis-ci.org/startxfr/docker-images) | [Dockerhub Registry](https://hub.docker.com/r/startx/sv-mongo/) | [Sources](https://github.com/startxfr/docker-images/tree/fc26/Services/mongo)             | [STARTX Profile](https://github.com/startxfr) | 
|-------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|---------------------------------------------------------------------------------|-----------------------------------------------|
...
```
service:
  image: startx/sv-mongo:fc26
  container_name: "service-mongo-fc26"
  environment:
    CONTAINER_TYPE: "service"
    CONTAINER_SERVICE: "mongo"
    CONTAINER_INSTANCE: "service-mongo-fc26"
  volumes:
    - "/tmp/container-fc26/logs/mongo:/logs"
    - "/tmp/container-fc26/mongo:/data"
```
...
data:
  ...
  container_name: "service-mongo-data-fc26"
  environment:
    CONTAINER_INSTANCE: "service-mongo-data-fc26"
service:
  image: startx/sv-mongo:fc26
  container_name: "service-mongo-fc26"
  environment:
