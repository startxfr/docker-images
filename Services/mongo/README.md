...
- `:fc31` : Fedora core 28 + MongoDB 3.6
...
```YAML
service:
  image: startx/sv-mongo:fc31
  container_name: "fc31-service-mongo"
  volumes:
...
service:
  image: startx/sv-mongo:fc31
  container_name: "service-mongo-fc31"
  ports:
    - "1000:27017"
```
...
data:
  ...
  container_name: "service-mongo-data-fc31"
service:
  image: startx/sv-mongo:fc31
  container_name: "service-mongo-fc31"
  volume_from:
...
```Dockerfile
FROM quay.io/startx/mongo:fc31
