...
service:
  ...
  container_name: "centos6-service-mongo"
  environment:
    CONTAINER_TYPE: "service"
    CONTAINER_SERVICE: "mongo"
    CONTAINER_INSTANCE: "centos6-service-mongo"
  volumes:
    - "/tmp/container-centos6/logs/mongo:/logs"
    - "/tmp/container-centos6/mongo:/data"
```
...
data:
  ...
  container_name: "centos6-service-mongo-data"
  environment:
    CONTAINER_INSTANCE: "centos6-service-mongo-data"
service:
  image: startx/sv-mongo:centos6
  container_name: "centos6-service-mongo"
  environment:
...
4. Run this container 
  1. Interactively with `docker run -p 27017:27017 -v /logs -it sv-mongo-centos6`. If you add a second parameter (like `/bin/bash`) to will run this command instead of the default entrypoint. Usefull to interact with this container (ex: `/bin/bash`, `/bin/ps -a`, `/bin/df -h`,...) 
  2. As a daemon with `docker run -p 27017:27017 -v /logs -d sv-mongo-centos6`
