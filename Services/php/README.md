# Docker OS Images : APACHE + PHP on Fedora 21
...
| [![Build Status](https://travis-ci.org/startxfr/docker-images.svg?branch=fc21)](https://travis-ci.org/startxfr/docker-images) | [Dockerhub Registry](https://hub.docker.com/r/startx/sv-php/) | [Sources](https://github.com/startxfr/docker-images/Services/php)             | [STARTX Profile](https://github.com/startxfr) | 
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|-------------------------------------------------------------------------------|-----------------------------------------------|
...
```
service:
  image: startx/sv-php:fc21
  container_name: "service-php-fc21"
  environment:
  ...
  volumes:
    - "/tmp/container-fc21/logs/php:/logs"
    - "/tmp/container-fc21/php:/data"
```
...
data:
  ...
  container_name: "service-php-data-fc21"
  environment:
    CONTAINER_INSTANCE: "service-php-data-fc21"
service:
  image: startx/sv-php:fc21
  container_name: "service-php-fc21"
  environment:
