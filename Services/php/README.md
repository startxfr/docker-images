...
You can import our [openshift builder stream](https://raw.githubusercontent.com/startxfr/docker-images/master/Services/php/openshift-imageStreams.yml) 
...
oc process -f startx-sv-php-build-template \
    -p APP_NAME=myapp \
| oc create -f -
```
...
oc new-project example
# start a new application
oc process -f startx-sv-php-deploy-template \
    -p APP_NAME=myapp \
| oc create -f -
```
