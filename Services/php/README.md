...
service:
  ...
  container_name: "service-php-centos6"
  environment:
    CONTAINER_TYPE: "service"
    CONTAINER_SERVICE: "php"
    CONTAINER_INSTANCE: "service-php-centos6"
    SERVER_NAME: "localhost"
    DOC_ROOT: "/data/apache_php"
  volumes:
    - "/tmp/container-centos6/logs/php:/data/logs/apache_php"
    - "/tmp/container-centos6/php:/data/apache_php"
```
...
data:
  ...
  container_name: "service-php-data-centos6"
  environment:
    CONTAINER_INSTANCE: "service-php-data-centos6"
service:
  image: startx/sv-php:centos6
  container_name: "service-php-centos6"
  environment:
