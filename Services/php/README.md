<!--[metadata]>
+++
title = "STARTX Docker Services Images : APACHE + PHP on Fedora 21"
description = "Docker container with apache + php service based on fedora 21"
keywords = ["home, docker, startx, apache, php, fedora 21, centos, repository, container, swarm, compose"]
weight=3
+++
<![end-metadata]-->
