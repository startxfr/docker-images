# Docker OS Images : APACHE + PHP on Fedora 26
...
| [![Build Status](https://travis-ci.org/startxfr/docker-images.svg?branch=fc26)](https://travis-ci.org/startxfr/docker-images) | [Dockerhub Registry](https://hub.docker.com/r/startx/sv-php/) | [Sources](https://github.com/startxfr/docker-images/tree/fc26/Services/php)             | [STARTX Profile](https://github.com/startxfr) | 
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|-------------------------------------------------------------------------------|-----------------------------------------------|
...
```
service:
  image: startx/sv-php:fc26
  container_name: "service-php-fc26"
  environment:
    CONTAINER_TYPE: "service"
    CONTAINER_SERVICE: "php"
    CONTAINER_INSTANCE: "service-php-fc26"
    SERVER_NAME: "localhost"
  volumes:
    - "/tmp/container-fc26/logs/php:/logs"
    - "/tmp/container-fc26/php:/data"
```
...
data:
  ...
  container_name: "service-php-data-fc26"
  environment:
    CONTAINER_INSTANCE: "service-php-data-fc26"
service:
  image: startx/sv-php:fc26
  container_name: "service-php-fc26"
  environment:
