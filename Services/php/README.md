# Docker OS Images : APACHE + PHP on Fedora 20
...
| [![Build Status](https://travis-ci.org/startxfr/docker-images.svg?branch=fc20)](https://travis-ci.org/startxfr/docker-images) | [Dockerhub Registry](https://hub.docker.com/r/startx/sv-php/) | [Sources](https://github.com/startxfr/docker-images/Services/php)             | [STARTX Profile](https://github.com/startxfr) | 
|-------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|-------------------------------------------------------------------------------|-----------------------------------------------|
...
```
service:
  image: startx/sv-php:fc20
  container_name: "service-php-fc20"
  environment:
  ...
  volumes:
    - "/tmp/container-fc20/logs/php:/logs"
    - "/tmp/container-fc20/php:/data"
```
...
data:
  ...
  container_name: "service-php-data-fc20"
  environment:
    CONTAINER_INSTANCE: "service-php-data-fc20"
service:
  image: startx/sv-php:fc20
  container_name: "service-php-fc20"
  environment:
