    ...
    <body>
        ...
        <div class="jumbotron">
            <div class="container">
                ...
                <p>You are actually running an apache webserver + php <?php echo phpversion(); ?>  running under fedora 26. For more information about this container and how to add your content instead of this message, please read the following links.</p>
                <p>
                    <a class="btn btn-primary btn-lg"href="https://github.com/startxfr/docker-images/tree/fc26/Services/php" target="_blank" role="button">See this container Dockerfile</a>
