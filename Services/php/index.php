...
<html>
    ...
    <body id="answer">
        ...
        <article>
            ...
            <p>
                You are actually running an apache webserver + php running under the 27 fedora release. For more information about this container and how to add your content instead of this message, please read the following links.
            <ul>
                <li><a href="https://github.com/startxfr/docker-images/tree/fc27/Services/php" target="_blank">See this container Dockerfile</a></li>
