    ...
    <body>
        ...
        <div class="jumbotron">
            <div class="container">
                ...
                <p>You are actually running an apache webserver + php <?php echo phpversion(); ?>  running under the fedora 35 release. For more information about this container and how to add your content instead of this message, please read the following links.</p>
                <p>
