<!--[metadata]>
+++
title = "STARTX Docker Services Images : MEMCACHE on Fedora 21"
description = "Docker container with memcache service based on fedora 21"
keywords = ["home, docker, startx, memcache, fedora 21, centos, repository, container, swarm, compose"]
weight=3
+++
<![end-metadata]-->
