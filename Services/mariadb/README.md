# Docker OS Images : MARIADB on CentOS 7
...
| [![Build Status](https://travis-ci.org/startxfr/docker-images.svg?branch=centos7)](https://travis-ci.org/startxfr/docker-images) | [Dockerhub Registry](https://hub.docker.com/r/startx/sv-mariadb/) | [Sources](https://github.com/startxfr/docker-images/tree/master/Services/mariadb)             | [STARTX Profile](https://github.com/startxfr) | 
|-------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|-----------------------------------------------------------------------------------|-----------------------------------------------|
...
* with `docker` you can run `docker run -it --name="service-mariadb-centos7" startx/sv-mariadb:centos7` from any docker host
...
service:
  ...
  volumes:
    - "/tmp/container-centos7/logs/mariadb:/logs"
    - "/tmp/container-centos7/mariadb:/data"
```
...
4. Run this container 
  1. Interactively with `docker run -p 3306:3306 -v /logs -it sv-mariadb-centos7`. If you add a second parameter (like `/bin/bash`) to will run this command instead of the default entrypoint. Usefull to interact with this container (ex: `/bin/bash`, `/bin/ps -a`, `/bin/df -h`,...) 
  2. As a daemon with `docker run -p 3306:3306 -v /logs -d sv-mariadb-centos7`
