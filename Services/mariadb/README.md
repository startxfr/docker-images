...
service:
  ...
  container_name: "service-mariadb-centos6"
  ports:
    - "3306:3306"
  environment:
  ...
  volumes:
    - "/tmp/container-centos6/logs/mariadb:/logs:z"
    - "/tmp/container-centos6/mariadb:/data:z"
```
...
data:
  ...
  container_name: "service-mariadb-data-centos6"
service:
  image: startx/sv-mariadb:centos6
  container_name: "service-mariadb-centos6"
  volume_from:
