...
* with `docker` you can run `docker run -it --name="service-mariadb-fc20" startx/sv-mariadb:fc20` from any docker host
* with `docker-compose` you can create a docker-compose.yml file with the following content
```
service:
  image: startx/sv-mariadb:fc20
  container_name: "service-mariadb-fc20"
  environment:
    CONTAINER_TYPE: "service"
    CONTAINER_SERVICE: "mariadb"
    CONTAINER_INSTANCE: "service-mariadb-fc20"
...
data:
  ...
  container_name: "service-mariadb-fc20-data"
  environment:
    CONTAINER_INSTANCE: "service-mariadb-fc20-data"
service:
  image: startx/sv-mariadb:fc20
  container_name: "service-mariadb-fc20"
  environment:
