...
- [Docker OS Images : COUCHBASE on Fedora 30](#docker-os-images--couchbase-on-fedora-30)
...
```YAML
service:
  image: startx/sv-couchbase:fc30
  container_name: "fc30-service-couchbase"
  volumes:
...
service:
  image: startx/sv-couchbase:fc30
  container_name: "service-couchbase-fc30"
  ports:
    - "1000:11211"
```
...
```Dockerfile
FROM quay.io/startx/couchbase:fc30
