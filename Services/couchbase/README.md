...
```YAML
service:
  image: startx/sv-couchbase:centos8
  container_name: "service-couchbase-centos8"
  volumes:
...
data:
  ...
  container_name: "service-couchbase-data-centos8"
  environment:
...
service:
  ...
  container_name: "service-couchbase-centos8"
  environment:
    CONTAINER_INSTANCE: "service-couchbase-centos8"
  volume_from:
    - data:rw
```
...
```Dockerfile
FROM quay.io/startx/couchbase:centos8
