...
- `:fc30` : Fedora core 28 + unoconv 0.7 + LibreOffice 5.0.3.2
...
```YAML
service:
  image: startx/sv-ooconv:fc30
  container_name: "fc30-service-ooconv"
  volumes:
...
service:
  image: startx/sv-ooconv:fc30
  container_name: "service-ooconv-fc30"
  ports:
    - "1000:2002"
```
...
```Dockerfile
FROM quay.io/startx/ooconv:fc30
