...
- `:fc32` : Fedora core 28 + unoconv 0.7 + LibreOffice 5.0.3.2
...
```YAML
service:
  image: startx/sv-ooconv:fc32
  container_name: "fc32-service-ooconv"
  volumes:
...
service:
  image: startx/sv-ooconv:fc32
  container_name: "service-ooconv-fc32"
  ports:
    - "1000:2002"
```
...
```Dockerfile
FROM quay.io/startx/ooconv:fc32
