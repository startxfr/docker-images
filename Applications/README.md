...
|---------------------|---------------------------------------------------------------------------|
| **PhpMyAdmin**      | `docker run -d -p 80:80 --name="centos6-pma" startx/app-pma:centos6`            | 
| **RockMongo**       | `docker run -d -p 80:80 --name="centos6-rockmongo" startx/app-rockmongo:centos6`| 
