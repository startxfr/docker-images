...
|-----------------|--------------------------------------------------------------------------------|--------------------------------
| PhpMyAdmin      | [`startx/app-pma:fc31`](https://hub.docker.com/r/startx/app-pma)               | [manual](pma/README.md)
| RockMongo       | [`startx/app-rockmongo:fc31`](https://hub.docker.com/r/startx/app-rockmongo)   | [manual](rockmongo/README.md)
...
|---------------------|---------------------------------------------------------------------------|
| **PhpMyAdmin**      | `docker run -d -p 80:80 --name="fc31-pma" startx/app-pma:fc31`            | 
| **RockMongo**       | `docker run -d -p 80:80 --name="fc31-rockmongo" startx/app-rockmongo:fc31`| 
