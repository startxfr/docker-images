# STARTX Docker-Images Applications based on Fedora 30
...
|-----------------|--------------------------------------------------------------------------------|--------------------------------
| PhpMyAdmin      | [`startx/app-pma:fc30`](https://hub.docker.com/r/startx/app-pma)               | [manual](pma/README.md)
| RockMongo       | [`startx/app-rockmongo:fc30`](https://hub.docker.com/r/startx/app-rockmongo)   | [manual](rockmongo/README.md)
