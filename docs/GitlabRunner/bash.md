<img align="left" src="https://raw.githubusercontent.com/startxfr/docker-images/master/docs/img/runner-bash.svg?sanitize=true">
...
| [`startx/runner-bash:centos9`](https://hub.docker.com/r/startx/runner-bash) | Centos 9            | 4.4.19 | 4.2.1 |
