...
| ----------------------------------------------------------------------------- | ------------------- | ---------- |
| [`startx/sv-couchbase:latest`](https://hub.docker.com/r/startx/sv-couchbase)  | Fedora core rawhide | 6.0.2-2413 |
| [`startx/sv-couchbase:34`](https://hub.docker.com/r/startx/sv-couchbase)      | Fedora core 34      |            |
| [`startx/sv-couchbase:33`](https://hub.docker.com/r/startx/sv-couchbase)      | Fedora core 33      |            |
